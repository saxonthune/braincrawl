...
| **Skill** | `doc02.03` | The agent-facing surface — how a consuming agent (e.g. a research skill) drives the graph: gather works once, read and judge at query time. |
...
See the README for the full motivation — separating *gathering works*
(build, expensive, done once) from *reading and judging* (query, cheap, repeatable).
