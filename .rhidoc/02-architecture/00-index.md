...
|---|---|---|
| **Core** | `doc02.01` | The platform-agnostic knowledge-graph engine. Itself decomposes into the three layers from the project goals: corpus, neutral metadata graph, consumer graphs. |
...
See the project goals (`GOALS.md`) for the full motivation — separating *coverage*
